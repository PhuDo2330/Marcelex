 ...
 * - Keeps the visual shell consistent across /admin/it/*
 * - No client hooks here to avoid "use client" unless needed.
 */
...
export default function ITLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex-1 p-6 md:p-8">
            ...
            {/* Sticky tab bar (simple non-active look; page body still controls its own active states if desired) */}
